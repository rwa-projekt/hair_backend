...
class Order(models.Model):
    ...
    barber = models.ForeignKey(Account, on_delete=models.SET_NULL, blank=True, null=True, default=None, related_name='barber')
...
class OrderItems(models.Model):
    ...
    barber = models.ForeignKey(Account, on_delete=models.SET_NULL, blank=True, null=True, default=None) # Mozda ovde vidit cemo s ivanom